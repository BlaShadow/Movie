...
@interface MovieResponseHandler : NSObject
...
/**
 MovieResponseHandler - Handle response from request a list of movies from API, then parse all the data and send it back to view
